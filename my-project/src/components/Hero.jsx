            ...
            <div className=" w-[270px] h-[344px] flex flex-col gap-4 2xl:w-[270px] 2xl:h-[344px] xl:w-[270px] xl:h-[344px] xl:items-start 2xl:items-start lg:items-center lg:w-[100%]  md:items-center md:w-[100%] sm:items-center sm:w-[100%]   mobile:items-center mobile:w-[100%] ">
              {heroLink.map((value, index) => {
                return (
                  <li
                    key={index}
                    className=" hover:cursor-pointer hover:text-myTheme  list-none hover:underline font-normal text-base text-black 2xl:text-[20px] xl:text-[18px] lg:text-[16px] md:text-[18px] sm:text-[15px] mobile:text-[15px]"
                    id={index}
                  >
                    {value.name}
                  </li>
              ...
              <div className="flex justify-center it  ">
                ...
                <div className="flex flex-col justify-center gap-1   ">
                  <div id="firstline" className="flex  items-center gap-[24px]">
                    <div>
                      <img
                        className=" 2xl:w-10 xl:w-10 lg:w-10 sm:w-6 md:w-6 mobile:w-6 2xl:h-12 xl:h-12 lg:h-12 md:h-7 sm:h-7 mobile:h-7"
                        src={apple}
                        alt=""
                      />
                    </div>
                    <h5 className="font-normal 2xl:text-base  xl:text-base lg:text-base sm:text-xs md:text-xs mobile:text-xs text-white">
                      iPhone 14 Series
                    </h5>
                  </div>
                  <div>
                    <h1 className=" 2xl:font-semibold  xl:font-semibold  lg:font-semibold  md:font-normal sm:font-normal mobile:font-normal   text-white leading-[60px] 2xl:text-6xl xl:text-5xl lg:text-4xl md:text-4xl sm:text-4xl mobile:text-xl">
                      <span className="flex flex-col gap-3">
                        <span>Up to 10% </span> <span>off Voucher</span>{" "}
                      </span>{" "}
                    </h1>
                  </div>
                  <div className="flex font-semibold - text-base gap-2  text-white  hover:cursor-pointer hover:text-myTheme">
                    {" "}
                    Shop Now{" "}
                ...
                <div id="apple phone side" className="-mb-20">
                  <img
                    className="2xl:w-[496px] xl:w-[496px] 2xl:h-[320px] xl:h-[320px] lg:w-[250px] md:w-[200px]  sm:w-[200px] mobile:w-[180px]  "
                    src={hero}
                    alt=""
                  />
                </div>
