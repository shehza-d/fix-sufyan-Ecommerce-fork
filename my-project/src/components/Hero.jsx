    ...
    <>
      <div id="heroMain" className=" w-[100%] h-[500px] 2xl:flex-row xl:flex-row lg:flex-col md:flex-col sm:flex-col mobile:flex-col flex mb-7 sm:mb-7 ">
        <div className=" 2xl:w-[30%]  xl:w-[30%] lg:w-[100%] md:w-[100%]   sm:w-[100%] mobile:w-[100%] center 2xl:pl-12 xl:pl-12 border-r ">
          <div className=" w-[270px] h-[344px] flex flex-col gap-4 2xl:w-[270px] 2xl:h-[344px] xl:w-[270px] xl:h-[344px] xl:items-start 2xl:items-start lg:items-center lg:w-[100%]  md:items-center md:w-[100%] sm:items-center sm:w-[100%]   mobile:items-center mobile:w-[100%] ">
            {heroLink.map((value, index) => {
              return (
                <li key={index} className=" hover:cursor-pointer hover:text-myTheme  list-none hover:underline font-normal text-base text-black" id={index}>
                  {value.name}
                </li>
              );
            })}
        ...
        <div className="  2xl:w-[70%] xl:w-[70%] lg:w-[100%] md:w-[100%] sm:w-[100%] 2xl:h-[500px] xl:h-[500px] lg:h-[100px] center">
          <div className=" bg-black w-[892px]    gap-4 2xl:w-[892px] 2xl:h-[344px] xl:w-[892px] xl:h-[344px] lg:w-[100%]  md:w-[100%] sm:w-[100%] mobile:w-[100%] ">
            {/* inner first div */}
             <div className="flex justify-center  "> 
              ...
              <div className='flex flex-col justify-center    '>
                ...
                <div>
                  <h1 className=' 2xl:font-semibold  xl:font-semibold  lg:font-semibold  md:font-normal sm:font-normal mobile:font-normal   text-white leading-[60px] 2xl:text-6xl xl:text-6xl lg:text-4xl md:text-4xl sm:text-4xl mobile:text-xl'><span className=''>Up to 10% </span><br />   off Voucher</h1>
                </div>
